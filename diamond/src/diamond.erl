...
row(Letter, Outside, Middle) when Middle > 0 -> 
    lists:flatten([spaces(Outside), Letter, spaces(Middle), Letter, spaces(Outside)]);
row(Letter, Outside, _) -> 
    lists:flatten([spaces(Outside), Letter, spaces(Outside)]).
...
diamond(Letter, Outside, Middle, Acc) ->
    diamond(Letter - 1, Outside + 1, Middle - 2, [row(Letter, Outside, Middle) | Acc]).
