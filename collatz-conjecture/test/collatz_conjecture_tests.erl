...
'7_non_integer_value_is_an_error_test'() ->
    ?assertMatch({error, 
            "Only positive numbers are allowed"}, 
...
'9_divide_if_even_tail_recursive_version_test'() ->
    ?assertMatch(4, collatz_conjecture_tr:steps(16)).

'10_even_and_odd_steps_tail_recursive_version_test'() ->
    ?assertMatch(9, collatz_conjecture_tr:steps(12)).

'11_large_number_of_even_and_odd_steps_tail_recursive_version_test'() ->
